...
insert into Partida (ganador, perdedor, fecha) values (1, 2, '2019-04-20 19:36:37.07');
...
insert into Equipo (partida, jugador, luchador) values 
(1, 1, 'L2');
...
primary key (codigo),
foreign key (usu_e) references Usuario (codigo),
foreign key (usu_r) references Usuario (codigo)
)
